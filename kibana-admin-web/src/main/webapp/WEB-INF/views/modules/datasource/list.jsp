...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/datasource/list">数据源列表</a></li>
		<shiro:hasPermission name="sys:user:edit">
			<li><a href="${ctx}/datasource/add?projectId=${projectId}">添加数据源</a></li>
		</shiro:hasPermission>
	</ul>
		...
		<tbody>
			<c:forEach items="${page.data}" var="entity">
				<tr>
					...
					<td><a href="${ctx}/datasource/add?id=${entity.id}">修改</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
