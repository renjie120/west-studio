...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/projectPage/list">项目页面列表</a></li>
		<shiro:hasPermission name="sys:user:edit">
			<li><a href="${ctx}/projectPage/add?projectId=${projectId}">添加项目页面</a></li>
		</shiro:hasPermission>
	</ul>
		...
		<tbody>
			<c:forEach items="${page.data}" var="entity">
				<tr>
					...
					<td><a href="${ctx}/projectPage/add?id=${entity.id}">处理</a>
						<a href="${ctx}/projectPage/show?id=${entity.id}">设计预览</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
