...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">职场:</label>
			<div class="controls">
                <sys:treeselect id="sysWorkArea" name="sysWorkArea.id" value="${office.sysWorkArea.id}" labelName="sysWorkArea.name" labelValue="${office.sysWorkArea.name}"
					title="区域" url="/sys/sysWorkArea/treeData" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">
