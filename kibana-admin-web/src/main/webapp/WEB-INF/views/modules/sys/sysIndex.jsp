	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li><a href="${pageContext.request.contextPath}${fns:getFrontPath()}/index-1.html" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-<script type="text/javascript">document.write(new Date().getFullYear())</script> ${fns:getConfig('productName')} - Powered By <a href="#" target="_blank">京东商城
	            </a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
