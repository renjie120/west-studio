...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href='#'>饼图<shiro:hasPermission name="sys:user:edit">${not empty entity.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:user:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form id="inputForm"  action="${ctx}/reportChart/save" method="post" class="form-horizontal">
		<input type="hidden" name="id" value="${param.id}">
		<input type="hidden" name="chartType" value="pipe">
