...
<body>
    <div class="hero-unit" style="padding-bottom:35px;margin:10px 0; background-image: url(http://static.bucuoa.com/logos/banner.jpg);" >
      <c:set var="article" value="${fnc:getArticle('14')}"/>
    ...
    <div class="row">
      <div class="span4">
        <h4><small><a href="${ctx}/list-18${urlSuffix}" class="pull-right">更多&gt;&gt;</a></small>网站导航</h4>
      ...
      <div class="span4">
        <h4> <small><a href="${ctx}/list-6${urlSuffix}" class="pull-right">更多&gt;&gt;</a></small>项目信息</h4>
